...
class quizModel extends Model{	
	...
	public function getAllScoresByUID(){
	    $_sql="select * from examination where uid=".$this->uid." order by id desc limit 0,10";
	    return parent::getAllResult($_sql);
	}
	...
	public function getChoice($_cid){
	    $_sql="select  * from veling_exam_choice where course_id=".$_cid." order by Rand() limit 0,25";
	    //echo $_sql;
	    return parent::getAllResult($_sql);
	}
	public function getJudge($_cid){
	    $_sql="select  * from veling_exam_judge where course_id=".$_cid." order by Rand() limit 0,25";
	    //echo $_sql;
	    return parent::getAllResult($_sql);
	}

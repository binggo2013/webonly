<?php
/* Smarty version 3.1.29, created on 2016-09-30 14:52:29
  from "/data/home/qyu1988070001/htdocs/application/views/admin/index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57ee0badd14533_45531763',
  'file_dependency' => 
  array (
...
function content_57ee0badd14533_45531763 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div id="mask"></div>
		<div class="container">
			<div class="row top">
				<div class="col-md-4 admin_logo">后台管理</div>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuDivider">
    <li><a href="#"><?php echo $_SESSION['oneAdmin']->name;?>
</a></li>
    <li role="separator" class="divider"></li>
	<li><a href="#"><?php echo $_SESSION['oneAdmin']->login_num;?>
次登录</a></li>
    <li role="separator" class="divider"></li>
	<li><a href="#"><?php echo $_SESSION['oneAdmin']->last_time;?>
</a></li>
	<li role="separator" class="divider"></li>
	<li><a href="#">IP:<?php echo $_SESSION['oneAdmin']->last_ip;?>
</a></li>
	<li role="separator" class="divider"></li>
      ...
      <div class="panel-body">
        <ul>
        	...
        	<li><a href="?a=dict&action=admin" target="main">字典管理</a></li> 
        		<li><a href="?a=message&action=show" target="main">信息管理</a></li> 
  ...
  <div class="panel panel-default">
   ...
   <div class="panel panel-default">
	...
	<div class="row">
		...
		<!-- <?php echo '<script'; ?>
 src="libs/Require/RequireJS.js" data-main="public/scripts/main" defer><?php echo '</script'; ?>
>-->
	</body>
</html>
<?php }

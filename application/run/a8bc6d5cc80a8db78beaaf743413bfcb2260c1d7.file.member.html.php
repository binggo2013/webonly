<?php /* Smarty version Smarty-3.1.19, created on 2015-09-21 07:49:21
         compiled from "/home/xiangruikong/public_html/application/views/home/member.html" */ ?>
<?php /*%%SmartyHeaderCode:19139412855463641382b964-08282916%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8bc6d5cc80a8db78beaaf743413bfcb2260c1d7' => 
    array (
      0 => '/home/xiangruikong/public_html/application/views/home/member.html',
      1 => 1442792956,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19139412855463641382b964-08282916',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_546364138d1081_64608524',
  'variables' => 
  array (
    'show' => 0,
    'oneUser' => 0,
...
<?php if ($_valid && !is_callable('content_546364138d1081_64608524')) {function content_546364138d1081_64608524($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>会员中心</title>
...
<?php if ($_smarty_tpl->tpl_vars['show']->value) {?>
	<div class="row">
		...
		<ul class="breadcrumb" style="margin-bottom:2px;">
			...
			<li class="active"><?php echo $_smarty_tpl->tpl_vars['oneUser']->value->username;?>
</li>			
		...
		<div class="tab panel panel-default highlight">	
			<form action="" method="post" enctype="multipart/form-data">				
					<div class="panel-body">
						<p><a href="javascript:void();" class="text-danger">修改</a>自己的资料</p>
				</div>
...
" style="display:none;">			
		...
		<div class="tab panel panel-default">			
				<div class="panel-heading">我的评论</div>
					<div class="panel-body">
						<p class="text-right"><a href="javascript:void(0);">所有评论</a></p>
				</div>
				<table class="table table-bordered table-striped table-hover">
...
?>
		...
		<div class="tab panel panel-default">			
				<div class="panel-heading">我的订单</div>
					<div class="panel-body">
						<p class="text-right"><a href="javascript:void(0);">所有订单</a></p>
				</div>
				<table class="table table-bordered table-striped table-hover">
...
?>
		...
		<div class="tab panel panel-default">			
				<div class="panel-heading">我的订单</div>
				<div class="panel-body">
						<p class="text-right"><a href="javascript:void(0);">所有成绩</a></p>
				</div>
				<table class="table table-bordered table-striped table-hover">
...
console.log(arr);
	...
	window.onload = function(){
		...
		<div class="tab panel panel-default">			
				...
				<div class="panel-body">
						<p class="text-right"><a href="javascript:void(0);">所有问答</a></p>
				</div>
				<table class="table table-bordered table-striped table-hover">
